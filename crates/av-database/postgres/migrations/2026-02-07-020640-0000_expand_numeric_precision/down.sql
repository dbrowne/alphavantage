-- Revert to original NUMERIC(20,8) and NUMERIC(30,8) precision
...
ALTER TABLE crypto_overview_basic
  ALTER COLUMN volume_change_24h TYPE NUMERIC(20,8),
  ALTER COLUMN current_price TYPE NUMERIC(20,8),
  ALTER COLUMN circulating_supply TYPE NUMERIC(30,8),
  ALTER COLUMN total_supply TYPE NUMERIC(30,8),
  ALTER COLUMN max_supply TYPE NUMERIC(30,8);

-- crypto_overview_metrics
ALTER TABLE crypto_overview_metrics
  ALTER COLUMN price_change_24h TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_24h TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_7d TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_14d TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_30d TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_60d TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_200d TYPE NUMERIC(20,8),
  ALTER COLUMN price_change_pct_1y TYPE NUMERIC(20,8),
  ALTER COLUMN ath TYPE NUMERIC(20,8),
  ALTER COLUMN ath_change_percentage TYPE NUMERIC(20,8),
  ALTER COLUMN atl TYPE NUMERIC(20,8),
  ALTER COLUMN atl_change_percentage TYPE NUMERIC(20,8),
  ALTER COLUMN roi_times TYPE NUMERIC(20,8),
  ALTER COLUMN roi_percentage TYPE NUMERIC(20,8);

-- Recreate views with original types
